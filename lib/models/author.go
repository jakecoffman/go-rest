...
type Author struct {
	...
	Born null.Time `boil:"born" json:"born,omitempty" toml:"born" yaml:"born,omitempty"`
...
var (
	authorAllColumns            = []string{"id", "name", "born"}
	authorColumnsWithoutDefault = []string{"name", "born"}
