...
type Book struct {
	...
	AuthorID int         `boil:"author_id" json:"authorID" toml:"authorID" yaml:"authorID"`
...
var BookWhere = struct {
	...
	AuthorID: whereHelperint{field: "\"book\".\"author_id\""},
	Title:    whereHelperstring{field: "\"book\".\"title\""},
	Genre:    whereHelpernull_String{field: "\"book\".\"genre\""},
}
...
var (
	bookAllColumns            = []string{"id", "author_id", "title", "genre"}
	bookColumnsWithoutDefault = []string{"author_id", "title", "genre"}
